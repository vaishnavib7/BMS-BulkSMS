...
if (isset($_POST['submit'])){
    ...
    if ($emailfound=='1'){
        ...
        //
        conf('login.php','s','Your Password is already reset. Please check your email.');
...
if (isset($_GET['_token'])){
    ...
    if ($tfnd=='1'){
        ...
        if ($send=='1'){
            ...
            conf('login.php','s','A new password is generated. Please check your email.');
        }
        //
    }
    else {
       conf($self,'e','Sorry password reset token expired or does not exist, Please try again');
    }
