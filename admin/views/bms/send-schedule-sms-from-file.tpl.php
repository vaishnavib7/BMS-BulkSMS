...
<link rel="stylesheet" type="text/css" href="views/bms/assets/js/jquery.niftymodals/css/component.css" />
...
$xfooter='
    ...
    <script src="views/bms/assets/js/jquery.niftymodals/js/jquery.modalEffects.js" type="text/javascript" ></script>
        <script src="views/bms/assets/js/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript" ></script>
                            ...
                            <form class="form-horizontal group-border-dashed" action="schedule-sms-send-from-file.php" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="step-pane" id="step2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea style="height:150px;" class="form-control" id="tmessage" name="tmessage"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <button type="button" style='margin-right:20px' onclick="generalTemplate('tmessage')"> General </button>
                                            <button type="button" style='margin-right:20px' onclick="comingUp('tmessage')"> Coming Up Soon </button>  
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-sm-3 control-label">Custom Message Templates</label>
                                        <div class="col-sm-6">
                                            <select class="select2" name="criteria_title" id="chosen_a" data-placeholder="Select Template" onchange="showHide('tmessage',this.value)" >
