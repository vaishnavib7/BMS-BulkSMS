...
<script type="text/javascript">
    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2><?php echo $Lan['Send_Individual_SMS']; ?></h2>
            <ol class="breadcrumb">
                <li><a href="index.php"><?php echo $Lan['Home']; ?></a></li>
                <li class="active"><?php echo $Lan['Send_Individual_SMS']; ?></li>
            </ol>
        </div>
        <div class="cl-mcont">
            <?php notify(); ?>
                ...
                <div class="col-md-12 fuelux">
                    <div class="block-wizard">
                        <div id="wizard1" class="wizard wizard-ux">
                            <ul class="steps">
                                <li data-target="#step1" class="active"><?php echo 'Enter Phone Number'; ?><span class="chevron"></span></li>
                        ...
                        <div class="step-content">
                            <form class="form-horizontal group-border-dashed" action="individual-sms-send.php" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate accept-charset="UTF-8">
                                <div class="step-pane active" id="step1">
                                    <div class="form-group no-padding">
                                        <div class="col-sm-7">
                                            <h3 class="hthin"><?php echo $Lan['Indvidual SMS']; ?></h3>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo 'Enter Phone Number'; ?></label>
                                        <div class="col-sm-6">
                                            <input type="text" required class="form-control" placeholder="<?php echo '+91 9999999999'; ?>" name="phoneno" id="phoneno" >
                                            <span class="error"><?php echo 'Use a Comma ( , ) to Seperate Different Numbers <br> Sample:   +91 9999999999,+91 999999998';?></span>

                                    <!--<select class="select2" multiple name="clgroups[]">
                                        $clgroup=ORM::for_table('accounts')->find_many()
                                                if ($clgroup->count()> 0) {
