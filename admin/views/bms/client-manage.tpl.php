...
<link rel=\"stylesheet\" href=\"views/bms/assets/js/jquery.crop/css/jquery.Jcrop.css\" />
";

$xfooter="

<script src=\"views/bms/assets/js/jquery.niftymodals/js/jquery.modalEffects.js\"></script>
<script src=\"views/bms/assets/js/masonry.js\"></script>
<script src=\"views/bms/assets/js/jquery.crop/js/jquery.Jcrop.js\"></script>
<script src=\"views/bms/assets/js/jquery.upload/js/jquery.iframe-transport.js\"></script>
<script src=\"views/bms/assets/js/jquery.upload/js/jquery.fileupload.js\"></script>
