...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,400italic,700,800' rel='stylesheet' type='text/css'>
    ...
    <!-- Bootstrap core CSS -->
    <link href="views/bms/assets/js/bootstrap/dist/css/bootstrap.css" rel="stylesheet" />
    <link rel="stylesheet" href="views/bms/assets/fonts/font-awesome-4/css/font-awesome.min.css">

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/jquery.gritter/views/bms/assets/css/jquery.gritter.css" />

    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/jquery.nanoscroller/nanoscroller.css" />
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/jquery.easypiechart/jquery.easy-pie-chart.css" />
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/bootstrap.switch/bootstrap-switch.css" />
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/bootstrap.datetimepicker/css/bootstrap-datetimepicker.min.css" />
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/jquery.select2/select2.css" />
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/bootstrap.slider/css/slider.css" />
    <link rel="stylesheet" type="text/css" href="views/bms/assets/js/intro.js/introjs.css" />

    <?php echo $xheader;?>
    <!-- Custom styles for this template -->
    <link href="views/bms/assets/css/style.css" rel="stylesheet" />
                ...
                <div class="content">
                    <div class="side-user">
                        ...
                        <div class="info">
                            ...
                            <img src="views/bms/assets/images/state_online.png" alt="Status" /> <span><?php echo $Lan['Online']; ?></span>
                        </div>
                    </div>
                    ...
                    <li><a href="#"><i class="fa fa-file"></i><span><?php echo "Templates"; ?></span></a>
                        <ul class="sub-menu">
                            <li <?php  if($url=='all-templates.php' OR $url=='edit-templates.php'){echo 'class="active"';} ?>><a href="all-templates.php"><?php echo "All Templates"; ?></a></li>
                            <li <?php  if($url=='add-new-templates.php'){echo 'class="active"';} ?>><a href="add-new-templates.php"><?php echo "Add Template"; ?></a></li>
                    </ul>
                    </li>
                    ...
                    <li><a href="#"><i class="fa fa-tablet"></i><span><?php echo $Lan['SMS']; ?></span></a>
                        <ul class="sub-menu">
                            <li <?php  if($url=='send-individual-sms.php'){echo 'class="active"';} ?>><a href="send-individual-sms.php"><?php echo 'Send Indvidual SMS'; ?></a></li>
                    ...
                    <li><a href="#"><i class="fa fa-cog"></i><span><?php echo $Lan['Settings']; ?></span></a>
                        <ul class="sub-menu">
