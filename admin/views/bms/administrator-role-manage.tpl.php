<?php
$xheader='
 <link href="views/bms/assets/js/jquery.icheck/skins/square/blue.css" rel="stylesheet">
 <link rel="stylesheet" href="views/bms/assets/js/jquery.niftymodals/css/component.css" />
';
$xfooter='
<script src="views/bms/assets/js/jquery.icheck/icheck.min.js" type="text/javascript"></script>
