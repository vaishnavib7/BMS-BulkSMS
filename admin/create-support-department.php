...
if (isset($_POST['submit'])){
  ...
  if ($email==''){
     ...
     if ($exist!='0'){
    conf($self,'e',"Email already exists. Use Another Department");
   }
  }    
...
$order++;
    ...
    $sid=$supdept->id();
      ...
      conf("support-department-manage.php?_sid=".$sid,'s','Support Department Added Successfully');  
}
 conf($self,'e','There are some problems. Please try again');
