...
if (isset($_POST['submit'])){
    ...
    if($sender_id!=''){
        ...
        if($f_sender){
            conf($self,'e','This Sender ID is Blocked By Administrator');
        }
    }
    ...
    if((!empty($_FILES["uploaded_file"])) && ($_FILES['uploaded_file']['error'] == 0)) {
        ...
        if (($ext == "txt") &&  ($_FILES["uploaded_file"]["size"] < 1000000)) {
            ...
            if (!file_exists($newname)) {
                ...
                unlink($newname);
                exit ("File already exists with the same name");
            }
        ...
        if ($gateway == 'NibsSMS') {
            ...
            for ($i = 0; $i < $listscount; $i++) {
                ...
                if ($sms_cost) {
                    ...
                    conf($self, 'e', 'Phone Number Coverage is not active');
                }
                @$clphone .= $list[$i] . ';';
            }
            ...
            if($sms_count>=$total_charge) {
                ...
                conf($self,'e','You Do Not Have Enough Balance to send this SMS');
            }
        }
            ...
            for($i = 0; $i < $listscount; $i++) {
                ...
                if ($gateway == 'Twilio') {
                    ...
                    if ($xstage != 'Demo') {
                        ...
                        $get_sms_status = 'Not Sent In demo Mode';
                    }
                }
    ...
    conf('sms-history.php','s','SMS Sent Successfully');
